...
public class boj_3029_경고 {
	static void solve() throws Exception {
		int day =  60*60*24;
		int before = toSecond(scan.nextLine());
		int after = toSecond(scan.nextLine());
		int sec = (after - before + day - 1) % day + 1;
		sb.append(toTimeString(sec));
	}

	static String toTimeString(int sec){
