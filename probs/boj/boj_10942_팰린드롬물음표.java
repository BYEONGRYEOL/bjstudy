...
public class boj_10942_팰린드롬물음표 {
	static void solve() throws Exception {
		// Case #1: a b c b a 일반적인 팰린드롬
		// Case #2: ababa 앞의 aba (0~2) 뒤의 aba(2~4) 가 각각 팰린드롬이므로 팰린드롬
		// Case #3: abadaba 앞의 aba(0~2) 뒤의 aba(4~6)이 각각 팰린드롬이므로 팰린드롬
		// Case #2 확장 : 0-2
		// abacbdbcaba
		int n= scan.nextInt();
		...
		for (int i = 0; i < query; i++) {
			sb.append(dp[scan.nextInt()-1][scan.nextInt()-1]).append('\n');
		}
	}
