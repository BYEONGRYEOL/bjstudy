...
public class boj_3063_게시판 {
	static void solve() throws Exception {
		int iter = scan.nextInt();
		for(int i =0; i < iter; i++){
			int[] box1 = scan.nextIntArray(4);
			int[] box2 = scan.nextIntArray(4);
			int box1Area = (box1[2]-box1[0]) * (box1[3] - box1[1]);
			int intersectionArea = getIntersectionArea(box1, box2);
			sb.append(box1Area - intersectionArea).append('\n');
